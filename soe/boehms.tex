...
%    } -- cycle;
  ...
  \draw (D5-5) node[left] {\tiny 100};
  \draw (D5-5) node[right] {\tiny 0};
  \draw (D5-4) node[left] {\tiny 80};
  \draw (D5-4) node[right] {\tiny 20};
  \draw (D5-3) node[left] {\tiny 60};
  \draw (D5-3) node[right] {\tiny 40};
  \draw (D5-2) node[left] {\tiny 40};
  \draw (D5-2) node[right] {\tiny 20};
  \draw (D5-1) node[left] {\tiny 20};
  \draw (D5-1) node[right] {\tiny 0};
