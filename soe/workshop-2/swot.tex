\section{SWOT analyse}\label{swot_analyse}
I denne sektion er projektet analyseret i forhold til dets styrker, svagheder, muligheder og trusler (SWOT analyse), for at give et overblik over projektes indre formåen (styrker og svagheder), men også for at belyse de elementer som kan påvirke projektet positivt og negativt (muligheder og trusler).
...
Det ses som en fordel at gruppen er blevet tildelt et ekstra grupperum, da det giver bedre mulighed for at teste robotten i det korrekte kørselsmiljø. 
Det fjerner desuden også støj fra det ''rigtige'' grupperum, således der kan arbejdes mere koncentreret.

\paragraph{not XScrum}
...
\todo[inline]{WTF? Denne kan jeg ikke huske...}
\todo[inline]{Dette er vores egen metode som vi er beskrevet og begrundet i workshop 1}
\mikkel{Nu er der mulighed for at skrive kommentarer med eget navn - ligesom i rapporten}
...
\paragraph{Manglende viden omkring MI}
...
\paragraph{Usikkerhed pga. løbende optagelse af viden}
...
\paragraph{Forskelligt niveau/kvalitet af kode}
...
\paragraph{Kode retningslinjer - bad smells}
...
\paragraph{Tilgængelige teknologier}
f.eks. til configuration Management (f.eks. CruiseControl.net)
\todo[inline]{kan ikke huske hvad denne gik ud på...}
...
\paragraph{Ny viden}
Der findes store muligheder i at tilegne sig ny og relevant viden via kurser og andet eksternt materiale.
...
Dette kan højne kvaliteten af projektet, da det giver kontrol over de problemer der skulle opstå.

\subsection{Trusler \textnormal{(\textbf{T}hreats)}}

\paragraph{Misuforståede læringsmål}
...
\paragraph{Vejleder skifter mening undervejs}
